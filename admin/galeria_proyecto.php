...
<p align="center"><a href="servicios.php" class="texto_contenido2">Volver</a></p>
<p align="center">&nbsp;</p>
<p align="center">&nbsp;</p>
...
?>
  <tr>
    <td width="25%" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"><a href="../detalleservicio/galeria/Upload_foto.php?foto=<?php echo $rs["id"]; ?>&amp;servicios=<?php echo $_GET["servicios"]; ?>" class="texto_contenido2">Cambiar foto</a></td>
      </tr>
      <tr>
        <td align="center"><img src="../detalleservicio/galeria/<?php echo $rs["id"]; ?>.jpg" width="200" /></td>
      </tr>
      <tr>
        <td align="center"><a href="galeria_proyecto.php?id=<?php echo $_GET["id"]; ?>&amp;fun=eli&amp;foto=<?php  echo $rs["id"];  ?>&amp;servicios=<?php echo $_GET["servicios"]; ?>" class="texto_contenido2">Eliminar</a></td>
      </tr>
    </table></td>
    ...
    <td width="25%" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="center" class="texto_f"><a href="galeria_proyecto.php?id=<?php echo $_GET["id"]; ?>&amp;fun=eli&amp;foto=<?php  echo $rs["id"];  ?>&amp;servicios=<?php echo $_GET["servicios"]; ?>" class="texto_contenido2">Eliminar</a></td>
      </tr>
    </table></td>
    <?php if($rs=mysql_fetch_array($sentencia,$mibase)){ ?>
    <td width="25%" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
